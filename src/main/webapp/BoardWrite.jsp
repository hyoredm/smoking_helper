<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.b3g1.dto.BoardInfo,com.b3g1.db.MySQLconnector"%>
<%
...
<script type="text/javascript">
	...
	function really() {
		var realConfirm = confirm('작성을 취소하고 게시판 목록으로 돌아가시겠습니까?');
		if (realConfirm) {
			document.location = "board?page=01";
		} else {
		}
	}
</script>
...
<!-- https://earlgreybutter.tistory.com/184 -->
		...
		<table border="1"
			...
			<tr>
				...
				<td style="padding-left:10px"><span style="margin-left:10px;margin-right:10px">글자 폰트: </span> <select id="fontSelect" name="text_font"
					...
					<span style="margin-left:10px;margin-right:10px">글자 색:</span>    <select id="colorSelect" name="text_color"
					onchange="changeStyle()" >
			...
			<tr>
				<td style="height:50px; table-layout: fixed"><input type="text" name="subject" id="textToChange"
			...
			<tr>
				...
				<td><textarea name="contents" style="resize: none;padding:10px;font-size: 25px;width:36.5em;height:18em" required></textarea></td>
			</tr>
			<tr style="border-bottom: none; border-left: none; border-right: none;">
				<td colspan='2'
					...
					style="float: right;"> <input type="submit" value="글쓰기" /><input
						type="button" style="margin-left: 10px" value="목록" onclick="really()" /></span></td>
			</tr>
	...
	<footer
		...
		<div style="height: 50px; text-align: center; margin: 0 auto;"></div></footer>
